...
import { isPrimOp, Exp, CExp, PrimOp, VarDecl } from './L4-ast';
...
export type SExpValue = Promise |number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | CompoundSExp;
