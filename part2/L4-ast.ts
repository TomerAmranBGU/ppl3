...
export interface Program {tag: "Program"; exps: Exp[]; } //V
export interface DefineExp {tag: "DefineExp"; var: VarDecl; val: CExp; } //V
export interface NumExp {tag: "NumExp"; val: number; } //V
export interface BoolExp {tag: "BoolExp"; val: boolean; } //V
export interface StrExp {tag: "StrExp"; val: string; } //V
export interface PrimOp {tag: "PrimOp"; op: string; } //V
export interface VarRef {tag: "VarRef"; var: string; } //V
export interface VarDecl {tag: "VarDecl"; var: string; } //V
export interface AppExp {tag: "AppExp"; rator: CExp; rands: CExp[]; }//V
// L2
